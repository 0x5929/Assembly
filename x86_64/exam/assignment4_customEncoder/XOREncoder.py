...
# File: XOREncoder.py
# Purpose: Given shellcode, Xor against 0xAA, then against 0xBB
# NOTE: Remember the 0xAA  or 0xBB must not appear in shellcode
...
for byte in bytearray(shellcode):			# xoring each byte of shellcode
	...
	output = output ^ 0xBB				# THIS IS THE ADDED ENCODER, XORING ONE MORE TIME
