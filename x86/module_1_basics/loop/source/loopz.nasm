...
; demostrating loopz
; loopz loops while ecx > 0 && zero flag = 1
; loopnz loops while ecx > 0 && zero flag = 0
...
PrintHW:
	...
	loopz PrintHW			; this will loop back to the PrintHW memory label, until ecx is 0 or until zero flag is not set
					; which will happen on the first iteration, zero flag is never set until ecx is 0, thus only printing once
